...
#endif
#define log_info(mod, fmt, ...)     log_print(AOS_LL_V_INFO,  mod, COL_BLU, "I", fmt, ##__VA_ARGS__)
#define log_warning(mod, fmt, ...)  log_print(AOS_LL_V_WARN,  mod, COL_YEL, "W", fmt, ##__VA_ARGS__)
#define log_err(mod, fmt, ...)      log_print(AOS_LL_V_ERROR, mod, COL_RED, "E", fmt, ##__VA_ARGS__)
