...
function files_cp()
{
	...
	# cp -rfa Living_SDK/platform/mcu/tg7100c/utils/include/utils_md5.h prebuild/include
...
if [[ ! -d Living_SDK/example/$2 ]] || [[ ! -d Living_SDK/out/$2@$3 ]]; then
	if [[ -d Living_SDK/example ]] && [[ -d Products/$1 ]] && [[ -d Products/$1/$2 ]]; then
		...
		echo "cp libs and incs start .............................................................................................................................."
		files_cp $1 $2 $3
        	echo "cp libs and incs end................................................................................................................................."
	else
